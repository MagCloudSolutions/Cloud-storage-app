...
const firebaseConfig = {
  apiKey: "AIzaSyAGMaxCi-vizGiDZTwqgouuObHb4Chmsl8",
  authDomain: "cs-cloud-23550.firebaseapp.com",
  projectId: "cs-cloud-23550",
  storageBucket: "cs-cloud-23550.appspot.com",
  messagingSenderId: "201066919876",
  appId: "1:201066919876:web:2f3f3f43f249158c8e9691",
  measurementId: "G-GNQY11TK3Q",
};
  ...
  storageRef
    ...
    .then((url) => {
      ...
      xhr.addEventListener("progress", function (event) {
        var progressValue = String((event.loaded / event.total) * 100).split(
          "."
        )[0];
        progress.style.width = progressValue + "%";
        percent.innerHTML = progressValue + "%";
